...
export const PORTFOLIO_CONFIGS: Record<string, PortfolioConfig> = {
  ...
  "market-dashboard": {
    sources: [
      ...
      { name: "Rigzone", url: "https://www.rigzone.com/", region: "both", rssUrl: "https://www.rigzone.com/news/rss/rigzone_latest.aspx" },
      { name: "EIA Today in Energy", url: "https://www.eia.gov/todayinenergy/", region: "both", rssUrl: "https://www.eia.gov/rss/todayinenergy.xml" },
      ...
      { name: "Manufacturers Monthly", url: "https://www.manmonthly.com.au/", region: "apac", rssUrl: "https://www.manmonthly.com.au/feed/" },
    ],
    indices: [
      ...energyIndices,
      ...lngIndices,
